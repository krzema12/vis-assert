...
class VerticalRangeStrictConstraintTest {
    ...
    fun assertMatchesWhenInInnerAndOuterRanges() {
        VerticalRangeStrictConstraint(
            xValues = listOf(1.0f, 2.0f, 3.0f), minY = 1.0f, innerMinY = 2.0f, innerMaxY = 3.0f, maxY = 4.0f)
            .assertMatches { x -> when (x) {
                1.0f -> 1.5f
                2.0f -> 2.5f
                3.0f -> 3.5f
                else -> 0.0f
    ...
    fun singleCapitalICharacterCheckIfMatches() {
        assertTrue(VerticalRangeStrictConstraintBuilder.columnMatchesThisConstraintType(
    ...
    fun capitalICharactersDividedBySpaceCheckIfMatches() {
        assertFalse(VerticalRangeStrictConstraintBuilder.columnMatchesThisConstraintType(
    ...
    fun manySubsequentCapitalICharactersBuildConstraint() {
        assertEquals(
                ...
                expected = VerticalRangeStrictConstraint(
                    xValues = listOf(1.23f), minY = 1.5f, maxY = 4.5f, innerMinY = 2.5f, innerMaxY = 3.5f))
    }
    ...
    fun manySubsequentCapitalICharactersWithoutSpaceBuildConstraint() {
        assertEquals(
                actual = VerticalRangeStrictConstraintBuilder.buildConstraintFromColumn(
                        ...
                        yAxisMarkers = listOf(AxisMarker(5.0f, 0), AxisMarker(1.0f, 4))),
                expected = VerticalRangeStrictConstraint(xValues = listOf(1.23f),
                    minY = 0.5f, maxY = 5.5f, innerMinY = 1.5f, innerMaxY = 4.5f))
    }
}
